...
<br><br><br><br>
	...
	<div class="theslider">
		...
		<div class="swiper-container">
			<div class="swiper-wrapper">
				  ...
				  <div class="swiper-slide" style="background:url('images/0afab18305410b5accb0b62c413d93a5.png');  background-size: cover;" >
	...
	<div class="post-detail">	
		Letting go all furniture used in our previous home, mostly still uable and durable. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam.
	</div>
	<!--end of post title-->
	...
	<!--exchange section-->
	<table cellpadding="20px" bgcolor="#0D2452"  cellspacing="20px" width="100%">
		<tr>
			<td class="left-padding"> 
				<img src="img/exdate.svg" />
				<div class="thin-line-abs2"></div>
			</td>
			<td class="left-padding" width="90%"> 
				<div class="post-small-ash">Jun 15th - 23rd
10am daily</div> 
			</td>
		</tr>
		...
		<tr>
			<td class="left-padding"> 
				<img src="img/exlocation.svg" /> 
			</td>
			<td width="90%" class="left-padding"> 
				<div class="post-small-ash">333 Fremont Street
San Francisco, CA. 94105</div> 
	...
	<table cellpadding="2px" class="standard-left2" cellspacing="2px" width="95%">
		<tr>
			<td width="50%"><input type="submit" value="I'm interested" class="post-red-button"/></td>
