			...
			<div class="headnav-other">
				...
				<table width="100%" cellpadding="15px" cellspacing="15px">
						...
						<tr>
							...
							<td align="center" class="headertext">"Twin Mattress"</td>
...
<br><br><br><br>
		...
		<table class="standard-top" width="100%" cellpadding="5px" cellspacing="5px">
			
			<tr>
	
				<td width="100%" class="wrap" align="left">
					<input type="text" class="navsearch-bared" placeholder="Search entire site"/> 
		...
		<!--the menu items-->
			<div class="menu-scroll" style="margin-top:-1px; z-index:10;">
