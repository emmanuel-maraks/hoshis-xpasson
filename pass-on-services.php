			...
			<tr>
				...
				<td>
					<table cellpadding="1px" cellspacing="1px">
						<tr>
							<td>
								<img width="41px" height="41px" src="img/fil/ServicePostIcon.svg" />
							</td>
							<td>
								<div class="type-section-text">Service Request</div>
							</td>
						</tr>
					</table>
				</td>
		...
		<tr>
			<td>
				...
				<table width="100%" bgcolor="#0D2452" cellpadding="10px" cellspacing="10px">
					<tr>
						<td>
							<div class="pass-on-exchanges">Offer</div>
						</td>
					</tr>
					
					<tr>
						<td align="left"  width="30%">
							<input type="text" class="signin-text-box2" placeholder="$ 0.00"/>
						</td>
						
						<td align="left"  width="40%">
							<div class="services-offer-text"> Hourly </div>
						</td>
