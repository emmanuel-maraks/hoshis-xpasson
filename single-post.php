...
<br><br><br><br>
	...
	<div class="theslider">
		...
		<table cellpadding="12px" cellspacing="12px" class="price-label">
		...
		<div class="swiper-container">
			<div class="swiper-wrapper">
				  ...
				  <div class="swiper-slide"  style="background:url('images/ec1bd85c9aaec9656f2814d04c2a7784.jpeg');  background-size: cover;" >
	...
	<div class="post-detail">	
		iphone 8 gold 64GB storage, bought in 2017 and used for developer testing. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam.... read more
	</div>
	<!--end of post title-->
	...
	<table cellpadding="2px" class="standard-left2" cellspacing="2px" width="95%">
		<tr>
			<td width="50%"><a href="interested-cash-sale.php?page=payment"><input type="submit" value="I’m Interested" class="post-red-button"/><a></td>
