...
<br><br><br><br>
	...
	<div class="theslider">
		...
		<div class="swiper-container">
			<div class="swiper-wrapper">
				  ...
				  <div class="swiper-slide" style="background:url('images/620x349.svg');  background-size: cover; ">
	...
	<div class="post-detail">	
		Professional electrical works, lightings, fittings, carpentary and related. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam.... read more
	</div>
	<!--end of post title-->
	...
	<table cellpadding="2px" class="standard-left2" cellspacing="2px" width="95%">
		<tr>
			<td width="50%"><input type="submit" value="Apply" class="post-red-button"/></td>
	...
	<table cellpadding="5px" class="standard-left2" cellspacing="5px" width="95%">
		<tr>
			<td lign="left"> <span class="similar-post-title">Similar Sevices</span> </td>
		</tr>
	</table>
