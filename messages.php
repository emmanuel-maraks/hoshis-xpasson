...
<body>
	...
	<div class="wh" onload="hidefilter()">
			...
			<div class="headnav-other">
				...
				<table width="100%" cellpadding="15px" cellspacing="15px">
						...
						<tr>
							...
							<td align="center" class="headertext">Messages</td>
		...
		<!--end of mobile header for messages-->
...
<br><br><br><br>
	...
	<table width="100%">
						...
						<td width="87%"> 
							 <table cellpadding="1px" cellspacing="1px" width="100%">
							 	<tr>
							 		...
							 		<td  width="10%">
									 	<img src="images/ec1bd85c9aaec9656f2814d04c2a7784.jpeg" alt="Donald Duck" width="50px" height="50px">
									 </td>
									 
									 <td width="70%">
										<span class="notfication-main-text"><b>Unlocked iPhone 8 Gold</b></span>
										<br>
										<span class="notfication-main-text2">Cynthia J. is interested</span>  
										<br>
		...
		<!--notification white item with read and action required-->
		<tr>
			<td>
				...
				<table cellpadding="8px" class="bg-white" cellspacing="8px" width="100%">
					...
					<tr>
						<td align="left" width="3%"> 
							<img class="not-rec-position2 " src="img/mesbar.svg" />
						</td>
						...
						<td width="87%"> 
							 <table cellpadding="1px" cellspacing="1px" width="100%">
							 	<tr>
									 ...
									 <td width="70%">
										<span class="notfication-main-text">Unlocked iPhone 8 Gold</span>
										<br>
										<span class="notfication-main-text2">Michael K. sent a message</span>  
										<br>
										<div class="notfication-time-text">1 min ago</div>
									</td>
		...
		<!-- end of notification white item with read and action required-->
						...
						<td width="87%"> 
							 <table cellpadding="1px" cellspacing="1px" width="100%">
							 	<tr>
							 		...
							 		<td  width="10%">
									 	<img src="images/166164b80fe8f4642fb7ffaacbc77815.jpeg" alt="Donald Duck" width="50px" height="50px">
									 </td>
									 
									 <td width="70%">
										<span class="notfication-main-text"><b>Rose Pink Apple Watch with Steel ...</b></span>
										<br>
										<span class="notfication-main-text2">Cynthia J. wants to exchange</span>  
										<br>
										<div class="notfication-time-text">1 min ago</div>
									</td>
						...
						<td width="87%"> 
							 <table cellpadding="1px" cellspacing="1px" width="100%">
							 	<tr>
							 		...
							 		<td  width="10%">
									 	<img src="images/0afab18305410b5accb0b62c413d93a5.png" alt="Donald Duck" width="50px" height="50px">
									 </td>
									 
									 <td width="70%">
										<span class="notfication-main-text"><b>Mississipi Garage Sale</b></span>
										<br>
										<span class="notfication-main-text2">Cynthia J. is interested</span>  
										<br>
										<div class="notfication-time-text">1 min ago</div>
