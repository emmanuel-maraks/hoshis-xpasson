...
<body>
    ...
    <div class="wh" onload="hidefilter()">
			...
			<div class="headnav-other">
				...
				<table width="100%" cellpadding="15px" cellspacing="15px">
						...
						<a href="index.php?log=logged">
							<img  src="img/close.svg" class="signin-close2"/>
						</a>
						...
						<tr>
							...
							<td align="center" class="headertext">Message Randy</td>
		...
		<!--end of mobile header for message-->
...
<br><br><br><br>
	...
	<!--post seller section-->
	<table cellpadding="7px" bgcolor="#E5E5E5" class="extra-top" cellspacing="7px" width="100%">
		<tr>
			<td>
				<table width="100%">
					<tr>
						<td align="left" >
							<img src="images/smile-face.svg" class="profile-photo" width="85px" height="81px" />
			
			
						</td>
		
						<td>
							<table class="extra-left" cellpadding="2px" cellspacing="2px" width="100%">
								<tr>
									<td>
								...
								<tr>
									<td align="left"> <div class="post-location-text2">OFFLINE</div> </td>
								</tr>
						...
						<td align="right" >
							<img src="images/ec1bd85c9aaec9656f2814d04c2a7784.jpeg"  width="85px" height="81px" />
		...
		<tr>
			...
			<td>
				<!--<a href="shipping.php?page=shipping">
					<input type="submit" class="signin-button" value="BUY NOW - $ 370.00"/>
				</a>-->
			</td>
	...
	<table cellpadding="10px" cellspacing="10px" width="100%">
		...
		<tr>
			<td align="right">
				<div class="text-frame">Is item available?</div>
				<div class="post-location-text2">Tap this button to begin conversation</div>
			</td>
		</tr>
		...
		<tr>
			<td align="left">
				<table>
					<tr>
						<td>
							<div class="option-frame">Yes</div> 
						</td>
						
						<td>
							<div class="option-frame">No</div>
						</td>
					</tr>
				</table>
				<div class="post-location-text2">Randy is yet to respond</div>
			</td>
		</tr>
	...
	<!--the foot text boxt-->
	<table width="100%" bgcolor="white" class="foor-text-box" cellpadding="3px" cellspacing="10px">
		...
		<tr>
			...
			<td align="center" width="80%">
				<input type="text" name="" class="in-text-box" />
			</td>
			
			<td>
				<button class="in-message-button"><i class="fa fa-play" aria-hidden="true"></i></button>
			</td>
		
		</tr>
	
	</table>
	<!--end of the foot text boxt-->
