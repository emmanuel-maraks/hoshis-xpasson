...
<body>
    ...
    <div class="wh" onload="hidefilter()">
			...
			<div class="headnav-other">
				...
				<table width="100%" cellpadding="15px" cellspacing="15px">
						...
						<tr>
							...
							<td align="center" class="headertext">My Profile</td>
		...
		<!--end of mobile header for profile-->
...
<br><br><br><br>
        ...
        <table width="80%" align="center" cellpadding="7px" cellspacing="7px">

                <tr>

                        <td align="center"><img src="images/smile-face.svg" onClick="pick()" width="130px" height="130px" class="profile-photo-main" /></td>
                ...
                <tr>
                        ...
                        <td> <input type="text" class="signin-text-box" value="Randy White Jr." placeholder="Your Full Name"/> </td>

                </tr>

                <tr>

                        <td> <input type="text" class="signin-text-box" value="randywhite@gmail.com" placeholder="Your Email"/> </td>
        ...
        <table width="80%" align="center" cellpadding="7px" cellspacing="7px">
                ...
                <tr>
                        ...
                        <td width="50%"> <input type="text" class="signin-text-box" value="*********" placeholder="Password"/> </td>

                

                        <td width="50%"> <div class="font-account-password-text">Change Password</div>  </td>
        ...
        <table width="80%" align="center" cellpadding="7px" cellspacing="7px">
                ...
                <tr>
                        ...
                        <td>  
                                <div class="font-account-password-text">Military status</div>
                        </td>
