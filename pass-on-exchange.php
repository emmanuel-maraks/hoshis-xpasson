			...
			<tr>
				...
				<td>
					<table cellpadding="5px" cellspacing="5px">
						<tr>
							<td>
								<img width="41px" height="41px" src="img/fil/ExchangePostIcon.svg" />
							</td>
							<td>
								<div class="type-section-text">Exchange</div>
							</td>
						</tr>
					</table>
				</td>
		...
		<tr>
			<td>
				...
				<table width="100%" bgcolor="#0D2452" cellpadding="10px" cellspacing="10px">
					<tr>
						<td>
							<div class="pass-on-exchanges">Exchanges</div>
						</td>
					</tr>
					
					<tr>
						<td>
							<input type="text" class="signin-text-box2" placeholder="First Item [COMPULSORY]"/>
						</td>
					</tr>
					
					<tr>
						<td>
							<input type="text" class="signin-text-box2" placeholder="Second Item"/>
						</td>
					</tr>
					
					<tr>
						<td>
							<input type="text" class="signin-text-box2" placeholder="Third Item"/>
						</td>
					</tr>
