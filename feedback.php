...
<body>
	...
	<div class="wh" onload="hidefilter()">
			...
			<div class="headnav-other">
				...
				<table width="100%" cellpadding="15px" cellspacing="15px">
						...
						<tr>
							...
							<td align="center" class="headertext">FeedBack</td>
		...
		<!--end of mobile header for feedback-->
...
<br><br><br><br>
        ...
        <table width="80%" align="center" cellpadding="7px" cellspacing="7px">
                ...
                <tr>
                        ...
                        <td> <input type="text" class="signin-text-box"  placeholder="Title"/> </td>

                </tr>

                <tr>

                        <td> <textarea  class="signin-text-box textarea-height" placeholder="Message..."></textarea> </td>
