			...
			<tr>
				<td>
					<table cellpadding="5px" cellspacing="5px">
						<tr>
							<td>
								<img width="41px" height="41px" src="img/fil/SalePostIcon.svg" />
							</td>
							<td>
								<div class="type-section-text">Cash Sale</div>
							</td>
						</tr>
					</table>
				</td>
				...
				<td>
					<a href="pass-on-exchange.php?page=passcash">
						<img id="ex-img" width="41px" height="41px" src="img/fil/ExchangePostIcon.svg" />
					</a>
				</td>
			
				<td>
					<a href="pass-on-services.php?page=passcash">
						<img id="se-img" width="41px" height="41px" src="img/fil/ServicePostIcon.svg" />
					</a>
				</td>
			
				<td>
					<a href="pass-on-events.php?page=passcash">
						<img id="ev-img" width="41px" height="41px" src="img/fil/EventPostIcon.svg" />
					</a>
				</td>
			</tr>
		...
		<tr>
			<td>
				...
				<table width="80%" cellpadding="2px" cellspacing="2px">
					<tr>
						<td width="40%">
							<input type="text" class="signin-text-box" placeholder="$ 0.00"/>
						</td>
						
						<td width="55%">
							<table cellpadding="5px" cellspacing="5px">
								<td>
									<input type="checkbox" class="i-want-pickup-radio" /> 
								</td>
								<td>
									<div class="i-want-pickup-text2" > Make this free !  </div>
								</td>
							</table>
						</td>
					...
					<tr>
						<td width="45%">
							<table cellpadding="2px" cellspacing="2px">
								<td>
									<input type="radio" class="i-want-pickup-radio" /> 
								</td>
								<td>
									<div class="i-want-pickup-text2" > Current Base  </div>
								</td>
							</table>
						</td>
						...
						<td width="55%">
							<table cellpadding="2px" cellspacing="2px">
								...
								<td>
									<div class="i-want-pickup-text2" > New / Previous Base </div>
								</td>
							</table>
						</td>
