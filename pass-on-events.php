...
<body>
	...
	<div class="wh" onload="hidefilter()">
		...
		<!--mobile header for pass on cash-->
		<div class="row">
			...
			<div class="headnav-other">
				...
				<table width="100%" cellpadding="15px" cellspacing="15px">
						...
						<tr>
							<td align="left"  width="20%"><a href="index.php?log=logged"><img src="img/Back.svg" /></a></td>
							
							<td align="center" class="headertext">Pass on</td>
		...
		<!--end of mobile header for pass on cash-->
...
<br><br><br><br>
	...
	function preview_image(event) 
	{
		 ...
		 document.getElementById("getlst").style.display = "none";
		 document.getElementById("preaddb2").style.display = "none";
	...
	{
		 document.getElementById("preaddb2").style.display = "none";
		 document.getElementById("addb2").style.display = "none";
		 document.getElementById("output_image2").style.display = "block";
		 document.getElementById("preaddb3").style.display = "none";
	...
	{
		 document.getElementById("preaddb3").style.display = "none";
		 document.getElementById("addb3").style.display = "none";
		 document.getElementById("output_image3").style.display = "block";
		 document.getElementById("preaddb4").style.display = "none";
		 document.getElementById("addb4").style.display = "block";
		 var reader = new FileReader();
		 reader.onload = function()
		 {
	...
	{
		 document.getElementById("preaddb4").style.display = "none";
		 document.getElementById("addb4").style.display = "none";
		 document.getElementById("output_image4").style.display = "block";
		 //document.getElementById("preaddb4").style.display = "none";
		 //document.getElementById("addb4").style.display = "block";
		 var reader = new FileReader();
		 reader.onload = function()
			...
			<tr>
				...
				<td>
					<a href="pass-on-cash.php?page=passcash">
						<img id="ex-img" width="41px" height="41px" src="img/fil/SalePostIcon.svg" />
					</a>				
				</td>
				
				<td>
					<a href="pass-on-exchange.php?page=passcash">
						<img id="se-img" width="41px" height="41px" src="img/fil/ExchangePostIcon.svg" />
					</a>
				</td>

				<td>
					<a href="pass-on-services.php?page=passcash">
						<img id="ev-img" width="41px" height="41px" src="img/fil/ServicePostIcon.svg" />
					</a>
				</td>
				...
				<td>
					<table cellpadding="1px" cellspacing="1px">
						<tr>
							<td>
								<img width="41px" height="41px" src="img/fil/EventPostIcon.svg" />
							</td>
							<td>
								<div class="type-section-text">Garage Sale</div>
							</td>
						</tr>
					</table>
				</td>
	...
	<!--end of Pass on Type Selection header-->
	...
	<table width="100%" cellpadding="7px" cellspacing="7px">
		<tr>
			<td>
				<input type="text" class="signin-text-box" placeholder="Item Title"/>
			</td>
		</tr>
		
		<tr>
			<td>
				<textarea class="signin-text-box textarea-height" placeholder="Item Description" ></textarea>
			</td>
		</tr>
		
		<tr>
			<td>
				<select class="signin-select-box">
		...
		<tr>
			<td>
				<div class="filt-icon">
					<table width="99%"  align="center" cellpadding="2px" cellspacing="2px">
						<tr>
							<td align="center">
								<img src="img/AddPhoto.svg" id="addb" onClick="fr()"/>
								<img id="output_image" class="prefr"  width="75px" height="75px"/>
								
								<div id="getlst" class="signin-check-box-text2">Add Photo</div>
								
								<input type="file" accept="image/*" onchange="preview_image(event)" class="zero"  name="" id="f" />
							</td>
						
							<td align="center">
								<img id="preaddb2" src="img/dot-circle.svg"/>
								<img src="img/AddPhoto.svg" class="prefr" id="addb2" onClick="fr2()"/>
								
								<img id="output_image2" class="prefr"  width="75px" height="75px"/>
								<input type="file" accept="image/*" onchange="preview_image2(event)" class="zero"  name="" id="f2" />
							</td>
						
							<td align="center">
								<img id="preaddb3" src="img/dot-circle.svg"/>
								<img src="img/AddPhoto.svg" class="prefr" id="addb3" onClick="fr3()"/>
								<img id="output_image3" class="prefr"  width="75px" height="75px"/>
								<input type="file" accept="image/*" onchange="preview_image3(event)" class="zero"  name="" id="f3" />
							</td>
						
							<td align="center">
								<img id="preaddb4" src="img/dot-circle.svg"/>
								<img src="img/AddPhoto.svg" class="prefr" id="addb4" onClick="fr4()"/>
								<img id="output_image4" class="prefr"  width="75px" height="75px"/>
								<input type="file" accept="image/*" onchange="preview_image4(event)" class="zero"  name="" id="f4" />
							</td>
						</tr>
					</table>
				</div>
		...
		<tr>
			<td>
				...
				<table width="100%" bgcolor="#0D2452" cellpadding="10px" cellspacing="10px">
					<tr>
						<td>
							<div class="pass-on-exchanges">Date / Time</div>
						</td>
					</tr>
					
					<tr>
						<td align="left"  width="20%">
							<input type="text" class="signin-text-box2" placeholder="MM/DD/YY"/>
						</td>
						
						<td align="left"  width="20%">
							<input type="text" class="signin-text-box2" placeholder="HH:MM"/>
						</td>
				...
				<table width="100%" bgcolor="#0D2452" cellpadding="10px" cellspacing="10px">
					...
					<tr>
						<td>
							<div class="pass-on-exchanges">Location</div>
						</td>
					</tr>
					
					<tr>
						<td>
							<input type="text" class="signin-text-box2" placeholder="Address 1"/>
						</td>
					</tr>
					
					<tr>
						<td>
							<input type="text" class="signin-text-box2" placeholder="Address 2"/>
						</td>
					</tr>
				...
				<table width="100%" bgcolor="#0D2452" cellpadding="10px" cellspacing="10px">
					...
					<tr>
						<td align="left"  width="20%">
							<input type="text" class="signin-text-box2" placeholder="STATE"/>
						</td>
						
						<td align="left"  width="20%">
							<input type="text" class="signin-text-box2" placeholder="ZIP CODE"/>
						</td>
		...
		<!--<tr>
			<td align="left"  width="30%">
				<div class="passon-loacation-text">Location</div>
			</td>
		</tr>
		...
		<tr>
			<td>
				...
				<table width="80%" cellpadding="2px" cellspacing="2px">
					<tr>
						<td width="40%">
							<input type="text" class="signin-text-box" placeholder="ZIP CODE"/>
						</td>
		...
		<tr>
  			<td> 
  				<a href="pass-on-exchange-confirmation.php?page=confirmation&log=logged">
					<input type="submit" class="signin-button" value="Pass on"> 
				</a>
			</td>
  		</tr>
