...
<html>
                                ...
                                <div class="headnav">
                                        ...
                                        <table width="100%" cellpadding="7px" cellspacing="7px">
                                                        ...
                                                        <tr>
                                                                ...
                                                                <td align="left"><a href="index.php"><img src="img/mlogo.svg" class="logo" /></a></td>
        
        
                                                                <td align="right">
                                                                        <table cellpadding="7px" cellspaing="7px" align="right">
        
                                                                                <tr>
        
                                                                                        <td align="right"><a href="notifications.php?page=notify&log=logged"><img src="img/mnal.svg"  /></a></td><!--use <img src="img/mnalr.svg"  /> when there is a notification-->
        
                                                                                        <td align="right"><a href="messages.php?page=message&log=logged"><img src="img/mnmsr.svg"  /></a></td><!--use <img src="img/mnms.svg"  /> when there is no notification-->
        
                                                                                        <td align="right"><a href="account.php?page=profile&log=logged"><img src="img/mnac.svg"  /></a></td><!--use <img src="img/mnacr.svg"  /> when there is a notification-->
                                        ...
                                        <table width="100%" class="perfect-fit" cellpadding="5px" cellspacing="5px">
                                        
                                                        <tr>
                                                                
                                                                <td width="100%" class="wrap" align="left">
                                                                        <input type="text" class="navsearch" placeholder="Search Xpasson..."/> 
                                                                        <a href="search.php?page=search" class="nav-search-button"><button class="nav-search-button"><i class="fa fa-search" aria-hidden="true"></i></button></a>
                                                                </td>
                                                                
                                                                <td width="10%"><i id="signs" class="fas fa-bars basic-header-text"></i></td>
                                                        
                                                        </tr>
        
                                                        <tr>
                                                                <td>
                                                                        <div class="head-filt-icon">
                                                                                
                                                                                
                                                                                                
                                                                                <a href="category.php?page=category" class="lin">
                                                                                        <div class="headnavtext">Cash Sales</div>
                                                                                </a>
                                                                        
        
                                                                        
                                                                                <a href="category.php?page=category" class="lin">
                                                                                        <div class="headnavtext">Services</div>
                                                                                </a>
                                                                        
        
                                                                        
                                                                                <a href="category.php?page=category" class="lin">
                                                                                        <div class="headnavtext">Exchanges</div>
                                                                                </a>
                                                                        
        
                                                                        
                                                                                <a href="category.php?page=category" class="lin">
                                                                                        <div class="headnavtext">Garage Sale</div>
                                                                                </a>
        ...
        <br><br><br><br>
                                ...
                                <div class="menu-scroll">
                                        ...
                                        <a href="category.php?page=category" class="lin"><div class="menu-scroll-item">Services</div></a>&nbsp;
                                        <a href="category.php?page=category" class="lin"><div class="menu-scroll-item">Exchanges</div></a>&nbsp;
                                        <a href="category.php?page=category" class="lin"><div class="menu-scroll-item">Garage Sale</div></a>&nbsp;
                                ...
                                <!--the banner-->
                                <div class="banner">
                                        <img src="images/banner.svg" width="100%" height="100%"/>
                                </div>
                                <!--end of the banner-->
                                ...
                                <div class="subheader">
                                        ...
                                        <span class="sub-header-main-text">Top Exchanges</span>
                                        <br>
                                        <span class="sub-header-sub-text">No money? Swap an existing item you own</span>
                                ...
                                <br>
                                <!--the product item slab-->
                                <div class="products-slab">
                                ...
                                <div class="subheader2">
                                        ...
                                        <div class="pink-bar">
                                                <img src="images/banner2.svg" width="100%"/>
                                        </div>
                                
                                </div>
                                <!--end of the sub header2-->
                                
                                
                                
                                <div class="product-slab2-head-text">
                                ...
                                <div class="subheader2">
                                        ...
                                        <span class="sub-header-main-text">Promoted Services</span>
                                        <br>
                                        <span class="sub-header-sub-text">Merchants offering deals / discounts</span>
                                
                                </div>
                                <!--end of the sub header3-->
